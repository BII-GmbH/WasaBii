...
namespace BII.WasaBii.Core {
    ...
    public interface IResult<out TError> : ResultBase {
        T Match<T>(Func<object, T> onSuccess, Func<TError, T> onError);
        void Match(Action<object> onSuccess, Action<TError> onError);
    }
    ...
    public static class Result {
        ...
        public static Success<TValue> Success<TValue>(this TValue result) => 
            new Success<TValue>(result);
        
        public static Result<TValue, TError> Failure<TValue, TError>(this TError error) =>
            new ErrorResult<TValue, TError>(error);

        public static Failure<TError> Failure<TError>(this TError error) => new Failure<TError>(error);
        ...
        public static Option<TError> TryGetError<TRes, TError>(this Result<TRes, TError> result) =>
            result.Match((TRes res) => Option<TError>.None, Option.Some);
    ...
    public abstract class Result<TValue, TError> : IResult<TValue, TError> {
        ...
        public TRes Match<TRes>(Func<object, TRes> onSuccess, Func<TError, TRes> onError) =>
            Match((TValue value) => onSuccess(value), onError);

        public void Match(Action<object> onSuccess, Action<TError> onError) =>
            Match((TValue value) => onSuccess(value), onError);
