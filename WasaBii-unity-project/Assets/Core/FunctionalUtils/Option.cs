...
namespace BII.WasaBii.Core {
    ...
    public static class Option {
        ...
        public static readonly UniversalNone None = new UniversalNone();
    ...
    [Serializable]//[CannotApplyEqualityOperator]
    ...
    public static class OptionQueryExtensions {
        ...
        public static T GetOrThrow<T>(this Option<T> opt) => opt.GetOrElse(() => 
