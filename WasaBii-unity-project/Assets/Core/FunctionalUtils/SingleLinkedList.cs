...
namespace BII.WasaBii.Core {
    ...
    public sealed class SingleLinkedList<T> : IEnumerable<T> {
        ...
        private static readonly ListLink Nil = new ListLink(default, null);
        ...
        [Pure] public SingleLinkedList<T> Prepend(T value) => new SingleLinkedList<T>(new ListLink(value, head));
