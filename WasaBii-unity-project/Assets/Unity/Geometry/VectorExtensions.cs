...
namespace BII.WasaBii.Unity.Geometry {
    ...
    public static class VectorExtensions {
        ...
        [Pure]
        public static Vector2 WithX(this Vector2 vec, [NotNull] Func<float, float> fx) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector2 WithY(this Vector2 vec, [NotNull] Func<float, float> fy) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector3 WithX(this Vector3 vec, [NotNull] Func<float, float> fx) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector3 WithY(this Vector3 vec, [NotNull] Func<float, float> fy) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector3 WithZ(this Vector3 vec, [NotNull] Func<float, float> fz) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector4 WithX(this Vector4 vec, [NotNull] Func<float, float> fx) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector4 WithY(this Vector4 vec, [NotNull] Func<float, float> fy) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector4 WithZ(this Vector4 vec, [NotNull] Func<float, float> fz) {
        ...
        /// of applying the specified function to the original value.</returns>
        [Pure]
        public static Vector4 WithW(this Vector4 vec, [NotNull] Func<float, float> fw) {
