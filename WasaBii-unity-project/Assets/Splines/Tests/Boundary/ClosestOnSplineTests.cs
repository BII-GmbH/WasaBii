...
namespace BII.WasaBii.Splines.Tests {
    public class ClosestOnSplineTests {
        ...
        [Test]
        public void QueryGreedyClosestPositionOnSplineTo_WhenInvalidSpline_ThenReturnsNull() {
            var invalidSpline = SplineTestUtils.ExampleInvalidSpline.Spline;
            Assert.That(invalidSpline.QueryClosestPositionOnSplineTo(Vector3.zero), Is.EqualTo(default(ClosestOnSplineQueryResult<Vector3, Vector3>?)));
        }
