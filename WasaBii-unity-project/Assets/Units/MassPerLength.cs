...
namespace BII.WasaBii.Units {
    ...
    public sealed class MassPerLengthUnit : Unit {
        private MassPerLengthUnit(string displayName, double factor) : base(displayName, factor) { }
    ...
    public readonly struct MassPerLength : ValueWithUnit<MassPerLength, MassPerLengthUnit> {
        public static readonly MassPerLength Zero = new MassPerLength(
            massPerLength: 0,
        ...
        //     => Mathd.Lerp(a._kilogramsPerMeter, b._kilogramsPerMeter, t).KilogramsPerMeter();
