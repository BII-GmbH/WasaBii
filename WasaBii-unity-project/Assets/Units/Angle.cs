...
namespace BII.Units {
    ...
    public sealed class AngleUnit : Unit {
        ...
        public static readonly AngleUnit Degrees = new AngleUnit("°", Mathf.PI / 180f);
    ...
    public readonly struct Angle : ValueWithUnit<Angle, AngleUnit> {
        ...
        [Pure] public Quaternion WithAxis(Vector3 axis) => Quaternion.AngleAxis((float)this.AsDegrees(), axis);
