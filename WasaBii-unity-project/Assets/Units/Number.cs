...
namespace BII.WasaBii.Units {
    ...
    public readonly struct Number : ValueWithUnit<Number, NumberUnit>, IFormattable{
        ...
        public IReadOnlyList<NumberUnit> AllUnits => NumberUnit.All;
        public NumberUnit DisplayUnit => NumberUnit.NoneUnit;
        public NumberUnit SIUnit => NumberUnit.NoneUnit;

        public static readonly Number Zero = new(number: 0.0, NumberUnit.NoneUnit);
        ...
        public int CompareTo(Number other) => SIValue.CompareTo(other.SIValue);
    }
